 ...
 *
 * The only data member of this class is a pointer to a SCC::GridFunction3d instance
...
#ifndef SCC_GRID_FUNCTION_3D_SLICE_OP_
#define SCC_GRID_FUNCTION_3D_SLICE_OP_
